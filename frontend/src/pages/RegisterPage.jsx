...
import { HiOutlineSun, HiOutlineMoon, HiOutlineUser, HiOutlineMail, HiOutlineLockClosed } from 'react-icons/hi';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 p-12 flex-col justify-between">
        <div>
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white leading-tight mb-4">
            Start reviewing<br />your code today.
          </h1>
          <p className="text-primary-100 text-lg">
            Create a free account and get AI-powered code analysis in seconds.
          </p>
        </div>
